...
def RecordSaveNew(AccountName, AccountId, Record, Balance):
...
while keepgoing0 == True:
    ...
    if account == "E":
        ...
        [account_name, account_id, record, balance] = RecordRead(account_id)
        keepgoing0 = False
...
RecordSaveNew(account_name, account_id, record, balance)
